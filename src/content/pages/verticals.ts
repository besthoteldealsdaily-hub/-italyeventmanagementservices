...
export const verticalPages: ContentPage[] = [
  ...
  page({
    ...
    related: ["destination-weddings-italy", "tuscany-wedding-transport", "how-to-choose-a-wedding-venue-in-italy", "wedding-accommodation-italy", "florence-event-management", "tuscany"],
  ...
  page({
    ...
    related: ["destination-weddings-italy", "lake-como-wedding-transport", "how-to-choose-a-wedding-venue-in-italy", "wedding-accommodation-italy", "luxury-event-management-italy", "lake-como"],
    cta: { label: "Plan my wedding", service: "wedding" },
    serviceType: "Destination wedding planning",
  ...
  page({
    ...
    related: ["destination-weddings-italy", "amalfi-coast-wedding-transport", "how-to-choose-a-wedding-venue-in-italy", "wedding-accommodation-italy", "amalfi-coast", "event-services-italy"],
    cta: { label: "Plan my wedding", service: "wedding" },
    serviceType: "Destination wedding planning",
    areaServed: ["Amalfi Coast", "Campania"],
  }),
